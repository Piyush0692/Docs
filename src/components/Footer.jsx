...
const Footer = () => {
  return (
    <div className=" flex gap-5 w-full h-auto bg-zinc-900 p-20 mt-16">
        <div className="w-1/2 font-FoundersGroteskXCondensed flex gap-32 flex-col justify-between items-start h-full">
            <div className="heading">
                <h1 className="text-[6vw] uppercase leading-none font-semibold -mb-6">Eye-</h1>
                <h1 className="text-[6vw] uppercase leading-none font-semibold -mb-6">Opening</h1>
            </div>
        ...
        <div className="w-1/2">
            <h1 className="text-[5vw] leading-none font-medium font-FoundersGroteskXCondensed">Contact Us</h1>
            <div className="border-[1px]"></div>
            <div className="links font-montreal mt-10 flex flex-col gap-3">
                <div className="link underline">Facebook</div>
                <div className="link underline">Twitter</div>
                <div className="link underline">Instagram</div>
                <div className="link underline">LinkedIn</div>
            </div>
            <div className="footer-desc flex justify-between items-center mt-10 font-montreal">
                <div>© ochi design 2024.</div>
